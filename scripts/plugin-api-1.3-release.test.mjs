...
test('API 1.3 release metadata is synchronized', async () => {
  ...
  assert.match(await read('packages/cyrene-core/src/plugin-contract.js'), /PLUGIN_API_VERSION = '1\.3\.0'/)
  assert.match(await read('src/plugins/constants.js'), /PLUGIN_API_VERSION/)
